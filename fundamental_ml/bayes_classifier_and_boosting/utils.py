...
def fetchDataset(dataset='iris'):
    if dataset == 'iris':
        ...
        y = genfromtxt('data/irisY.txt', delimiter=',',dtype=int)-1
        pcadim = 2
    elif dataset == 'olivetti':
        X = genfromtxt('data/olivettifacesX.txt', delimiter=',')
        X = X/255
        y = genfromtxt('data/olivettifacesY.txt', delimiter=',',dtype=int)
        pcadim = 20
    elif dataset == 'vowel':
        X = genfromtxt('data/vowelX.txt', delimiter=',')
        y = genfromtxt('data/vowelY.txt', delimiter=',',dtype=int)
        pcadim = 0
    else:
...
# `fetchDataset` can be provided with any of the dataset arguments `iris`, `olivetti` and `vowel`.
